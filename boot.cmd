# Bootscript enabling Torizon's Verdin Development Board LVDS display (Verdin --> Mezzanine --> Touch/I2C,Display/LVDS)
...
env set bootcmd_args 'env set bootargs quiet video=LVDS-1 initcall_blacklist=vpu_driver_init rootfstype=squashfs root=/dev/ram autoinstall ${teziargs}'
